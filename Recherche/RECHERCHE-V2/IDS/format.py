...
def main():
    ...
    parser.add_argument("--data-dir", default="logs", help="T-Pot data folder (default /data)")
    parser.add_argument("--out-file", default="data/logs.csv", help="Output file (csv or parquet)")
